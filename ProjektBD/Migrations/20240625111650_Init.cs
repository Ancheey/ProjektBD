        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rentals_Emplyees_RentingId",
                        column: x => x.RentingId,
                        principalTable: "Emplyees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rentals_Readers_RenterId",
                        column: x => x.RenterId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusDateChange = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
